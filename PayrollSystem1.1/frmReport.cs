...
namespace PayrollSystem1._1
{
    public partial class frmReport : Form
    {
        ...
        {
            btnweeklypayroll.BackColor = Color.DarkSeaGreen;
        }
        ...
        {
            btnPayslip.BackColor = Color.DarkSeaGreen;
        }
        ...
        private void btnweeklypayroll_leave_MouseLeave(object sender, EventArgs e)
        {

        }

        private void btnPayslip_leave_MouseLeave(object sender, EventArgs e)
        {
