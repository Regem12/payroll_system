    ...
    public partial class frmPayroll : Form
    {
        ...
        private void load_data(string search)
        {
            ...
            if (!string.IsNullOrEmpty(search))
            {
                sql = @"
SELECT 
    p.emp_code AS 'AssignCode', 
    p.num_days AS 'NumberofDays', 
    p.r_wage AS 'RateWage', 
    p.gross_sal AS 'GrossIncome', 
    p.net_income AS 'NetIncome', 
    p.remarks AS 'Remarks', 
    p.dateissued AS 'DateIssued', 
    CONCAT(e.emp_fname, ' ', e.emp_lname) AS 'Employee', 
    ew.d_rate AS 'DailyRate', 
    od.total_ded AS 'TotalDeduction', 
    ew.position AS 'Position' 
FROM 
    payroll AS p
JOIN 
    employee_workinfo AS ew ON ew.emp_code = p.emp_code
JOIN 
    other_deduction AS od ON od.emp_code = p.emp_code
JOIN 
    employee AS e ON e.emp_code = p.emp_code 
WHERE 
    p.emp_code LIKE '%" + search + @"%'
GROUP BY 
    p.emp_code;";
            }
            else {
...
";
        ...
        {
            string search = txtpsearch.Text;

            load_data(search);
        }

        private void txtPPayPeriod_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (!char.IsDigit(e.KeyChar) && !char.IsControl(e.KeyChar))
            {
                e.Handled = true; // Ignore the key press if it's not a letter
            }
        }

        private void txtPNoDays_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (!char.IsDigit(e.KeyChar) && !char.IsControl(e.KeyChar))
            {
                e.Handled = true; // Ignore the key press if it's not a letter
        ...
        private void txtPRegOtHr_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (!char.IsDigit(e.KeyChar) && !char.IsControl(e.KeyChar))
            {
                e.Handled = true; // Ignore the key press if it's not a letter
        ...
        private void txtPholPayDay_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (!char.IsDigit(e.KeyChar) && !char.IsControl(e.KeyChar))
            {
                e.Handled = true; // Ignore the key press if it's not a letter
        ...
        private void txtpcadvance_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (!char.IsDigit(e.KeyChar) && !char.IsControl(e.KeyChar))
            {
                e.Handled = true; // Ignore the key press if it's not a letter
        ...
        private void txtpphic_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (!char.IsDigit(e.KeyChar) && !char.IsControl(e.KeyChar))
            {
                e.Handled = true; // Ignore the key press if it's not a letter
        ...
        private void txtppagibig_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (!char.IsDigit(e.KeyChar) && !char.IsControl(e.KeyChar))
            {
                e.Handled = true; // Ignore the key press if it's not a letter
        ...
        private void txtpdeduct1_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (!char.IsDigit(e.KeyChar) && !char.IsControl(e.KeyChar))
            {
                e.Handled = true; // Ignore the key press if it's not a letter
        ...
        private void txtpdeduct2_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (!char.IsDigit(e.KeyChar) && !char.IsControl(e.KeyChar))
            {
                e.Handled = true; // Ignore the key press if it's not a letter
        ...
        private void txtpdeduct3_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (!char.IsDigit(e.KeyChar) && !char.IsControl(e.KeyChar))
            {
                e.Handled = true; // Ignore the key press if it's not a letter
        ...
        private void txtpdeduct4_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (!char.IsDigit(e.KeyChar) && !char.IsControl(e.KeyChar))
            {
                e.Handled = true; // Ignore the key press if it's not a letter
